...
def generate_uuid
  rand_arr_holder = []
  eligible_alphanum = 'abcdefghijklmnopqrstuvwxyz0123456789'.split('')
  32.times do 
    rand_arr_holder << eligible_alphanum.sample
  end
  rand_arr_holder.insert(8, '-')
  rand_arr_holder.insert(13, '-')
  rand_arr_holder.insert(18, '-')
  rand_arr_holder.insert(23, '-')
  return rand_arr_holder.join
end
